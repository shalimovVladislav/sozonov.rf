                ...
                <div className={classes['flex-container']}>
                    <div className={classes['text-container']}>
                        ...
                        <p className={classes['color-white']}>
                            Компания предлагает высококачественные комплекты кровопроводящих магистралей. Наша продукция обеспечивает надежную и безопасную процедуру перитонеального гемодиализа для пациентов.
                        </p>
